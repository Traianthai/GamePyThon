...
class Enemy1:
    def __init__(self,size):
        ...
        self.list = []
        for i in range(0,6):
            enemy = pygame.transform.scale(pygame.image.load(f'GamePyThon\dog\enemies\enemy1\enemy1.{i}.png'),(int(293*self.size),int(155*self.size))).convert_alpha()
...
class Enemy2:
    def __init__(self,size):
        ...
        self.list = []
        for i in range(0,6):
            enemy = pygame.transform.scale(pygame.image.load(f'GamePyThon\dog\enemies\enemy2\enemy2.{i}.png'),(int(266*self.size),int(188*self.size))).convert_alpha()
            self.list.append(enemy)
...
class Bug:
    def __init__(self):
        ...
        for i in range (0,15):
            if i >= 10:
                bug_animation = pygame.transform.scale(pygame.image.load(f"GamePyThon/dog/bug_png/skeleton-animation_{i}.png"),(self.bug_size*11,self.bug_size*9)).convert_alpha()
            else:
                bug_animation = pygame.transform.scale(pygame.image.load(f"GamePyThon/dog/bug_png/skeleton-animation_0{i}.png"),(self.bug_size*11,self.bug_size*9)).convert_alpha()
...
class Background:
    def __init__(self):
        ...
        for i in range(1,6):
            background = pygame.transform.scale(pygame.image.load(f'GamePyThon/dog/backgroundLayers/layer-{i}.png'),(1700,WINDOWHEIGHT)).convert_alpha()
...
class Boom:
    def __init__(self,x,y):
        ...
        self.list = []
        for i in range (0,5):
            animation = pygame.transform.scale(pygame.image.load(f"GamePyThon/dog/enemies/boom/boom{i}.png"),(self.size*179,self.size*200)).convert_alpha()
